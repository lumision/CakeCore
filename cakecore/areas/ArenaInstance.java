...
public class ArenaInstance 
{
	...
	public static final File arenasFile = new File("plugins/CakeCore/arena-instances.yml");
	...
	public Location getSpawnLocation()
	{
		...
		spawnLocation = new Location(Bukkit.getWorld(CakeCore.areaInstanceWorld), (arenaInstanceID * 256) + 0.5F, 64, 0.5F);
	...
	public Location[] getExitLocations()
	{
		...
		for (int i = 0; i < exitLocations.length; i++)
			exitLocations[i] = new Location(
					Bukkit.getWorld(CakeCore.areaInstanceWorld), arenaInstanceID * 256, 64, 0).add(arena.exitInternals.get(i));
	...
	public static BukkitWorld getArenaInstanceWorld()
	{
		...
		return arenaInstanceWorld = new BukkitWorld(Bukkit.getWorld(CakeCore.areaInstanceWorld));
	}

	public static void readData()
	{
		arenaInstanceList.clear();
