...
public class SageSkeleton extends RPGMonster
{
	...
	public SageSkeleton(Monster entity)
	{
		...
		RItem rBoots = CakeCore.getItemFromDatabase("SageSkeletonBoots");
		RItem rChestplate = CakeCore.getItemFromDatabase("SageSkeletonRobe");
		RItem rLeggings = CakeCore.getItemFromDatabase("SageSkeletonPants");
		RItem rHelmet = CakeCore.getItemFromDatabase("SageSkeletonHood");
		RItem rHand = CakeCore.getItemFromDatabase("SageSkeletonSceptre");
