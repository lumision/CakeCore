...
import cakecore.npc.ConversationData.ConversationLine;
...
public class CustomNPC extends EntityPlayer 
{
	...
	public void tick2()
	{
		...
		{
			randomLookTicks = 40 + CakeCore.rand.nextInt(40);
			targetYaw += 50 - CakeCore.rand.nextInt(101);
			targetPitch += 20 - CakeCore.rand.nextInt(41);
			if (targetPitch < -30)
	...
	{
		deleteNPC();
		CakeCore.npcManager.createNPCUsernameSkin(getBukkitLocation(), this.name, name);
	}
