...
public class RPGSkill 
{
	...
	public static HashMap<Projectile, Callable<Void>> customProjectiles = new HashMap<Projectile, Callable<Void>>();
	public static Projectile customProjectile;
	public static Entity customProjectileVictim;
	...
	public void precast(RPlayer player)
	{
		player.lastSkill = skillName;
		player.castDelays.put(skillName, (int) (castDelay * player.getStats().attackSpeedMultiplier));
		player.globalCastDelay = 1;
	}
	...
	public static abstract class SkillEffect 
	{
		...
		public SkillEffect(RPGMonster mob, int castDelay, int damage)
		{
			this.mob = mob;
			this.castDelay = castDelay;
			this.damage = damage;
