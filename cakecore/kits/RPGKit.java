...
public class RPGKit
{
	...
	public static final File kitsFolder = new File("plugins/CakeCore/kits");
	...
	public static void readData()
	{
		...
		if (kitsFolder.exists())
			for (File folder : kitsFolder.listFiles())
			{
				...
				{
					CakeCore.msgConsole("&4Error reading kit folder: " + folder.getName());
					e.printStackTrace();
				}
			}
		KitHistory.readData();
	...
	public static class TimeTrack
	{
		...
		{
			return new TimeTrack().hasPassed(this);
		}
	...
	public static class KitHistory
	{
		...
		public static final File kitHistoryFile = new File("plugins/CakeCore/kit-histories.yml");
		...
		{
			return getTimeTrackOffset().hasPassed();
		}

		public void check()
		{
			RPlayer rp = RPlayerManager.getRPlayer(player);
			if (rp == null)
				return;
		...
		public static void readData()
		{
			...
			for (String line: CakeLibrary.readFile(kitHistoryFile))
			{
				...
				{
					CakeCore.msgConsole("Error reading kitHistory data line: &c" + line);
					e.printStackTrace();
				}
			}
		}
