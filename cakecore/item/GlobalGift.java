...
{
	public static final File giftsFile = new File("plugins/CakeCore/global-gifts.yml");
	...
	public static void readData()
	{
		...
		for (String line: CakeLibrary.readFile(giftsFile))
		{
			try
			{
				...
				createGlobalGift(CakeCore.getItemFromDatabase(split[0]), Integer.valueOf(split[1]), Integer.valueOf(split[2]), Integer.valueOf(split[3]));
			} catch (Exception e)
			{
				CakeCore.msgConsole("Error reading gift file line: " + line);
				e.printStackTrace();
			}
		}
	}
