...
import cakecore.entities.bosses.CorruptedMage;
import cakecore.entities.bosses.UndeadEmperor;
import cakecore.entities.minibosses.DiamondZombie;
import cakecore.entities.minibosses.QueenSpider;
...
public class RPGMonsterSpawn
{
	...
	public static final File dropsFolder = new File("plugins/CakeCore/mob-drops");
	...
	public static void onEnable()
	{
		...
		//Mobs
		spawns.add(new RPGMonsterSpawn(ReinforcedSkeleton.class, Skeleton.class, 500, 1500, 4));
		spawns.add(new RPGMonsterSpawn(ReinforcedSpider.class, Spider.class, 500, 1500, 4));
		spawns.add(new RPGMonsterSpawn(ReinforcedZombie.class, Zombie.class, 500, 1500, 4));
		
		spawns.add(new RPGMonsterSpawn(AssassinSpider.class, Spider.class, 1000, 2500, 4));
		spawns.add(new RPGMonsterSpawn(MageZombie.class, Zombie.class, 1000, 2500, 4));
		spawns.add(new RPGMonsterSpawn(WarriorZombie.class, Zombie.class, 1000, 2500, 4));

		spawns.add(new RPGMonsterSpawn(SorcererZombie.class, Zombie.class, 2000, 3500, 4));
		spawns.add(new RPGMonsterSpawn(FighterZombie.class, Zombie.class, 2000, 3500, 4));
		spawns.add(new RPGMonsterSpawn(RogueSpider.class, Spider.class, 2000, 3500, 4));

		spawns.add(new RPGMonsterSpawn(TricksterSpider.class, Spider.class, 3000, 4500, 4));
		spawns.add(new RPGMonsterSpawn(SageSkeleton.class, Skeleton.class, 3000, 4500, 4));
		spawns.add(new RPGMonsterSpawn(BrawlerZombie.class, Zombie.class, 3000, 4500, 4));
	...
	public static int getHPFromSquaredSpawnDistance(double distanceSquared)
	{
		...
		return calc < 0 ? 2147483647 : calc < 5 ? 5 : calc;
	}
	...
	public static void readDrops()
	{
		for (File file: dropsFolder.listFiles())
		{
			try
			{
				...
				if (spawn == null)
				{
					CakeCore.msgConsole("&4Error reading drops file: " + file.getName() + "; spawn \"" + split[1] + "\" does not exist.");
					continue;
				}
				...
				if (ri == null)
				{
					CakeCore.msgConsole("&4Error reading drops file: " + file.getName() + "; RItem parsing");
					continue;
				}
				if (split.length >= 3)
			...
			{
				CakeCore.msgConsole("&4Error reading drops file: " + file.getName());
				e.printStackTrace();
			}
		}
	}
	...
	public void saveDrops()
	{
		...
		for (RItem key: drops)
		{
			...
			{
				CakeCore.msgConsole("&4Error writing drops file: " + rpgMonsterName + " / " + CakeLibrary.getItemName(key.itemVanilla));
				e.printStackTrace();
			}
		}
	}
