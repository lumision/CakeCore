...
public class ConversationData
{
	...
	public static File dataFolder = new File("plugins/CakeCore/npc-conversations");
	...
	public static class ConversationLine
	{
		...
		{
			return lines.get(CakeCore.rand.nextInt(lines.size()));
		}
	...
	public static void readConversationData()
	{
		...
		for (File file: dataFolder.listFiles())
		{
			...
			try
			{
				...
				CakeCore.msgConsole("&4Error reading conversation data file: " + file.getName());
				e.printStackTrace();
				continue;
			}
		}
